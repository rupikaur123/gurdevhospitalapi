...
/*  Passwords routes */
Route::post('forgot_password', [AuthController::class, 'resetPassword']);
Route::get('password/reset/{token}', [AuthController::class, 'confirmResetPassword']);
Route::post('password/create', [AuthController::class, 'createNewPassword']);
